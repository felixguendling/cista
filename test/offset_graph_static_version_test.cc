...
TEST_CASE("graph offset serialize file - static version") {
...
TEST_CASE("graph offset serialize buf - static version") {
  constexpr auto const MODE =
      cista::mode::WITH_INTEGRITY | cista::mode::WITH_STATIC_VERSION;
...
TEST_CASE("graph offset serialize mmap file - static version") {
...
TEST_CASE("graph offset serialize endian test - static version") {
